...
if (findGamesBtn && locationSearch && gameResults) {
    findGamesBtn.addEventListener('click', (e) => {
        ...
        // Simulate loading
        gameResults.innerHTML = '<p class="loading">Searching for games near ' + location + '...</p>';
        ...
        setTimeout(() => {
            ...
            const sampleGames = [
                {
                    name: 'Community Center Roundnet',
                ...
                {
                    name: 'Beach Roundnet League',
                    location: location + ' Beach Park',
                    address: '456 Ocean Dr, ' + location,
                    day: 'Saturdays',
                    time: '10:00 AM - 2:00 PM',
                    level: 'Intermediate/Advanced',
                    contact: 'beachleague@example.com'
                },
                {
                    name: 'University Roundnet Club',
            ...
            // Create results HTML
            let resultsHTML = `
                <h4>Games found near ${location}:</h4>
